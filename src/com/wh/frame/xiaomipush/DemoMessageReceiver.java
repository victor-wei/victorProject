package com.wh.frame.xiaomipush;
...
import com.wh.victorwei.activity.MainActivity;
import com.wh.victorwei.activity.MyApplication;
    ...
    public static class DemoHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (MainActivity.sMainActivity != null) {
                ...
                if (msg.what==1) {
                	Log.i(MyApplication.TAG,"refreshPushState");
